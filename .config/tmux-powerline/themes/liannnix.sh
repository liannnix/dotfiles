...
if [ -z "$TMUX_POWERLINE_WINDOW_STATUS_CURRENT" ]; then
	TMUX_POWERLINE_WINDOW_STATUS_CURRENT=(
		"#[fg=colour255,bg=colour130,nobold,noitalics,nounderscore]"
        #"#[$(format inverse)]"
...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		#"battery 137 127"
		"battery 235 255 ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}"
		#"date_day 235 136"
		#"date_day 235 255"
		"date 235 255 ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}"
		#"time 235 255 ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}"
		#"pwd 89 211"
